...
from integrations.bots.helpers import NotEnoughData, NotRelated, cleanup_title, get_trust_score_emoji
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                logging.warning(f'No valid bot token found: {str(e)}')
                logging.warning('Retrying in 5 seconds...')
                time.sleep(5)  # Wait for 5 seconds before retrying
            except KeyboardInterrupt:
                logging.info('Shutting down Discord listener...')
                break
            except Exception as e:

...
BETA_FEAT_ON = config('BETA_FEAT_ON', default=False, cast=bool)
SELFHOSTED_DEFAULT_EMBEDDING = config('SELFHOSTED_DEFAULT_EMBEDDING', default='text-embedding-3-small')
SELFHOSTED_DEFAULT_EMBEDDING_DIMENSION = config('SELFHOSTED_DEFAULT_EMBEDDING_DIMENSION', default=1536, cast=int)

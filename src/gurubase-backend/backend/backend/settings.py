...
DATA_SOURCES_LIMIT_TOTAL_GITHUB_REPO_COUNT = config('DATA_SOURCES_LIMIT_TOTAL_GITHUB_REPO_COUNT', default=2, cast=int)
DATA_SOURCES_GITHUB_FILE_COUNT_LIMIT_PER_REPO_HARD_LIMIT = config('DATA_SOURCES_GITHUB_FILE_COUNT_LIMIT_PER_REPO_HARD_LIMIT', default=1000, cast=int)
DATA_SOURCES_GITHUB_FILE_COUNT_LIMIT_PER_REPO_SOFT_LIMIT = config('DATA_SOURCES_GITHUB_FILE_COUNT_LIMIT_PER_REPO_SOFT_LIMIT', default=1200, cast=int)
DATA_SOURCES_GITHUB_REPO_SIZE_LIMIT_MB = config('DATA_SOURCES_GITHUB_REPO_SIZE_LIMIT_MB', default=100, cast=int)
...
CRAWL4_AI_BASE_DIRECTORY = config('CRAWL4_AI_BASE_DIRECTORY', default='/workspace/.crawl4ai')
